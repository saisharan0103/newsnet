...
| **2.4 Gemini API integration** (content moderation, sentiment analysis) | 6h | 2.2 | ✔️ | Auto-screen new stories before storing/submitting on-chain. |
...
- **Slow AI moderation** → Cache Gemini results or implement short circuiting for trusted users.
